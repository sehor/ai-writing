"""External Hermes agent server integration port.

The core app talks to the external agent only through this client
boundary; routers reach it via application services, never directly.
"""
