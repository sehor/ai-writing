...
type ManuscriptChapterDraft = Omit<ManuscriptChapter, 'id' | 'project_id'>
...
type ReferenceSuggestionStatus = 'pending_review' | 'accepted' | 'rejected'
type ReferenceScopeType =
  | 'project'
  | 'snowflake_step'
  | 'scene'
  | 'canon_entity'
